    ...
    <View style={{ 
      ...
      <ScrollView>
        <View style={{ 
          ...
          <FlatList data={product.productImageList ? product.productImageList : null} horizontal renderItem={renderProduct}
        ...
        alignItems:"center"
         ...
         style={{ 
           ...
           <Text style={{ 
            ...
            }}>{product.isAvailable ? 'Add to cart' : 'Not Avialable'}</Text>
         </TouchableOpacity>
      </View>
    </View>
  )
